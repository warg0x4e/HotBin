...
WizardStyle=modern
OutputBaseFilename=HotBin-2.6.8.0-setup
OutputDir=.
SourceDir=.
VersionInfoVersion=2.6.8.0

[Files]
Source: "HotBin-2.6.8.0-x64.exe"; DestDir: "{app}"; DestName: "HotBin.exe"; Check: Is64BitInstallMode; Flags: ignoreversion
Source: "HotBin-2.6.8.0-x86.exe"; DestDir: "{app}"; DestName: "HotBin.exe"; Check: not Is64BitInstallMode; Flags: ignoreversion
